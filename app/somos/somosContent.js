...
export const heroContent = {
    title: 'Esta es nuestra iglesia',
    description: 'Saddleback Church started 35 years ago with two young church planters, a dream, and a map. God gave Pastor Rick and Kay Warren the dream to plant a church for people who didn’t like church, and he led them to Southern California. The rest is a history that’s still unfolding.',
    imageUrl: 'https://images.unsplash.com/photo-1531592937781-344ad608fabf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80'
}
...
export const valores = [
    {
        ...
        description: <p>“No se contenten sólo con escuchar la palabra, pues así se engañan ustedes mismos. Llévenla a la práctica.”
            <br></br>Santiago 1:22 (NVI)</p>
    },
    {
        title: 'Servicio',
        mainTitle: '2. VALORAMOS EL SERVICIO.',
        description: <p>“Porque… el Hijo del hombre no vino para que le sirvan, sino para servir y para dar su vida en rescate por una multitud.”
    ...
    },
    {
        ...
        description: <p>“Cada uno debe examinar su propia conducta. Si es buena, podrá sentirse satisfecho de sus acciones, pero no debe compararse con los demás.”
            <br></br>Gálatas 6:4 (BLS)</p>
    },
    {
        title: 'Personas',
        mainTitle: '4. VALORAMOS COMO RESPONDEN LAS PERSONAS A LA ESCRITURA.',
        description: <p>“El necio cree que todo lo que hace está bien, pero el sabio atiende los consejos.”
            <br></br>Proverbios 12:15 (DHH)
            <br></br><br></br>
            “Adquiere la verdad y no la vendas; adquiere sabiduría, disciplina e inteligencia.”
            <br></br>Proverbios 23:23 (RVA)</p>
    },
    {
        title: 'Autenticidad',
        mainTitle: '5. VALORAMOS LA AUTENTICIDAD.',
        description: <p>“Nos satisface saber que nos hemos comportado bien, y que hemos sido sinceros con todos, especialmente con ustedes. No lo hicimos guiados por nuestra propia prudencia, sino con la ayuda de Dios, y gracias a su gran amor.”
            <br></br>2 Corintios 1:12 (BLS)</p>
    },
    {
        title: 'Informalidad',
        mainTitle: '6. VALORAMOS LA INFORMALIDAD.',
        description: <p>“El corazón tranquilo da vida al cuerpo,…”
            <br></br>Proverbios 14:30 (NVI)</p>
    },
    {
        title: 'Dones',
        mainTitle: '7. VALORAMOS LOS DONES ESPIRITUALES DE LA GENTE.',
        description: <p>“Dios nos ha dado diferentes dones, según lo que él quiso dar a cada uno.”
    ...
    },
    {
        ...
        description: <p>“Hay diversas maneras de servir, pero un mismo Señor. Hay diversas funciones, pero es un mismo Dios el que hace todas las cosas en todos.”
            ...
            <br></br>Filipenses 2:2 (DHH)</p>
    },
    {
        title: 'Aprendizaje',
        mainTitle: '9. VALORAMOS EL APRENDIZAJE CONSTANTE.',
        description: <p>“El que aprende y pone en práctica lo aprendido, se estima a sí mismo y prospera.”
            ...
            <br></br>Eclesiastés 10:10 (NVI)</p>
    },
    {
        title: 'Simplicidad',
        mainTitle: '10. VALORAMOS LA SIMPLICIDAD.',
        description: <p>Tan sólo he hallado lo siguiente: que Dios hizo perfecto al género humano, pero éste se ha buscado demasiadas complicaciones.»”
            ...
            <br></br>1 Corintios 2:1 (BLS)</p>
    },
    {
        title: 'Equipo',
        mainTitle: '11. VALORAMOS EL TRABAJO EN EQUIPO.',
        description: <p>“Pues bien, ustedes son el cuerpo de Cristo, y cada uno de ustedes es un miembro con su función particular.”
            ...
            <br></br>Romanos 12:5 (DHH)</p>
    },
    {
        title: 'Innovación',
        mainTitle: '12. VALORAMOS LA INNOVACIÓN.',
        description: <p>“Los sabios e inteligentes adquieren los conocimientos que buscan.”
            <br></br>Proverbios 18:15 (DHH)</p>
    },
    {
        title: 'Libertad',
        mainTitle: '13. VALORAMOS LA LIBERTAD Y LA FLEXIBILIDAD.',
        description: <p>“… y donde está el Espíritu del Señor, allí hay libertad.”
            ...
            <br></br>Gálatas 5:13 (BLS)</p>
    },
    {
        title: 'Humor',
        mainTitle: '14. VALORAMOS EL HUMOR.',
        description: <p>“Gran remedio es el corazón alegre, pero el ánimo decaído seca los huesos.”
            <br></br>Proverbios 17:22 (NVI)
            <br></br><br></br>
            “El corazón alegre se refleja en el rostro, el corazón dolido deprime el espíritu.”
            <br></br>Proverbios 15:13 (NVI)</p>
    },
    {
        title: 'Optimismo',
        mainTitle: '15. VALORAMOS EL OPTIMISMO.',
        description: <p>“Entonces Jesús, mirándolos, les dijo: —Para los hombres es imposible; pero no para Dios. Porque para Dios todas las cosas son posibles.”
            <br></br>Marcos 10:27 (RVA)
            <br></br><br></br>
            “—Que se haga conforme a la fe que ustedes tienen.”
            <br></br>Mateo 9:29 (DHH)</p>
    },
    {
        title: 'Crecimiento',
        mainTitle: '16. VALORAMOS EL CRECIMIENTO.',
        description: <p>“Cristo es quien va uniendo a cada miembro de la iglesia, según sus funciones, y hace que cada uno trabaje en armonía, para que la iglesia vaya creciendo y cobrando más fuerza por causa del amor.”
            ...
            <br></br>Colosenses 2:19 (DHH)</p>
    },
    {
        title: 'Consagración',
        mainTitle: '17. VALORAMOS LA CONSAGRACIÓN DE LOS CREYENTES.',
        description: <p>“Hicieron más de lo que esperábamos. Primero se entregaron a sí mismos al Señor, y después a nosotros. De este modo, hicieron lo que Dios esperaba de ellos.”
            <br></br>2 Corintios 8:5 (BLS)</p>
    }
]
...
export const propositosUnicos = [
    {
        ...
        description: <p className='description'><b>Ministerios Betesda</b> existe para celebrar la presencia de Dios por medio de la adoración <em>(Magnificar)</em>,
            ...
            <br></br><br></br> y demostrar el amor de Dios por medio del servicio <em>(Ministerio)</em>.</p>,
    ...
    {
        title: 'Visión',
        description: <p className='description'>Es el sueño de un lugar en donde los heridos, los deprimidos, los frustrados y los confundidos puedan encontrar amor, aceptación, ayuda, esperanza, perdón, guía y aliento.
            <br></br><br></br>
    ...
    {
        title: 'Propósito',
        description: <p className='description'><b>Nuestro Propósito</b> Atraer y Ganar no-creyentes, desarrollar en ellos una madurez cristiana, y conducirlos a un ministerio significativo en la iglesia y la vida de misión en el mundo en cada área y parte de sus vidas.
            <br></br><br></br>
    ...
    },
    {
        ...
        description: <p className='description'>Nuestros Grupos Pequeños fueron diseñados para proporcionar el crecimiento continuo y permanente de nuestros miembros. Y están basados en el trabajo de individuos inspirados, entrenados y equipados para el discipulado.
            <br></br><br></br>
